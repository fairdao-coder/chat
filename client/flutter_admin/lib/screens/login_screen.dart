        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text('聊天后臺管理系統', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold)),
              const SizedBox(height: 4),
              const Text('Chat Admin Console', style: TextStyle(color: AppTheme.textSub)),
              const SizedBox(height: 24),
              TextField(
                controller: _userCtrl,
                decoration: const InputDecoration(labelText: '管理員賬號', prefixIcon: Icon(Icons.person)),
              ),
