...
class L10n {
  ...
  static const Map<String, String> _en = {
    ...
    '搜索': 'Search',
    '未找到匹配的好友': 'No matching friends',
    '我们已成了好朋友': 'We are friends now',
    ...
    '当前平台不支持扫码': 'Scanning is not supported on this platform',
    '请在手机端使用扫一扫功能': 'Please use the scan feature on a phone',
    '去设置': 'Open settings',
    ...
    '分享我的名片': 'Share My Profile',
    '通过链接发起对话': 'Start a chat via link',
    '扫码即可发起对话': 'Scan to start a chat',
    '复制分享链接': 'Copy Share Link',
    '已复制链接': 'Link copied',
    '请先登录后再发起对话': 'Please sign in before starting a chat',
    '联系客服': 'Contact Support',
    '向在线客服咨询': 'Chat with an online agent',
    '当前没有客服在线': 'No support agents online',
    '客服': 'Support',
  ...
  static const Map<String, String> _es = {
    ...
    '搜索': 'Buscar',
    '未找到匹配的好友': 'No se encontraron amigos',
    '我们已成了好朋友': 'Ya somos amigos',
    ...
    '发现': 'Descubrir',
    '网页': 'Página web',
    '在浏览器打开': 'Abrir en el navegador',
    '我': 'Yo',
    '好友': 'Amigos',
    '暂无好友': 'Sin amigos',
    '暂无栏目': 'Sin columnas',
    '修改密码': 'Cambiar contraseña',
    '旧密码': 'Contraseña actual',
    '新密码': 'Nueva contraseña',
    '确认新密码': 'Confirmar nueva contraseña',
    '至少6位': 'Al menos 6 caracteres',
    '请输入旧密码': 'Introduce la contraseña actual',
    '密码长度至少6位': 'La contraseña debe tener al menos 6 caracteres',
    '两次输入的新密码不一致': 'Las contraseñas no coinciden',
    '确认修改': 'Guardar',
    '密码修改成功': 'Contraseña cambiada',
    '网络错误，请重试': 'Error de red, inténtalo de nuevo',
    ...
    '当前平台不支持扫码': 'El escaneo no es compatible con esta plataforma',
    '请在手机端使用扫一扫功能': 'Usa la función de escaneo en el teléfono',
    '去设置': 'Abrir ajustes',
    ...
    '分享我的名片': 'Compartir mi perfil',
    '通过链接发起对话': 'Iniciar chat por enlace',
    '扫码即可发起对话': 'Escanea para iniciar un chat',
    '复制分享链接': 'Copiar enlace',
    '已复制链接': 'Enlace copiado',
    '请先登录后再发起对话': 'Inicia sesión antes de iniciar un chat',
    '联系客服': 'Contactar soporte',
    '向在线客服咨询': 'Habla con un agente en línea',
    '当前没有客服在线': 'No hay agentes en línea',
    '客服': 'Soporte',
